...
const COLS: Col[] = [
  { key: "symbol", label: "Market", val: (r) => r.symbol, render: (r) => <Link href={`/markets/${r.marketId}`} className="mono-link" style={{ fontWeight: 700 }}>{r.symbol}</Link> },
